...
public class addDialog extends GBDialog {
	...
	JLabel idLbl = addLabel("<html><font color='white'>ID Number (type '0' for autogenerated):</font></html>", 3,1,1,1);
	...
	private void checkID() throws FormatException {
		if(id.getText().trim().equals("")) {
			throw new FormatException("Please enter an id number.");
		}
		if(!id.isValidNumber() || id.getNumber()<0) {
			throw new FormatException("Please enter a valid id number.");
		}
		if(p.duplicateId(id.getNumber())) {
			throw new FormatException("Duplicate id number.");
		}
	}
}